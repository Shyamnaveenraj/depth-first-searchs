...
<h3>Register Number:  212223230118   </h3>
<H3>Aim:</H3>
...
for i in range(e):
    ...
    graph[v].append(u)
#print(graph)
start=' '    ##'A' for sample input 1, '0' for sample input 2
...
![image](https://github.com/user-attachments/assets/14c0e860-8156-4495-b2de-2f537df89fcd)
...
![image](https://github.com/user-attachments/assets/19c401c5-ee01-4e42-803e-02b4a0ceb82b)
